...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Uni\\stuff\\NSC\\code\\NSC_model_overthinking\\Online Task\\PsychoPy\\OverthinkingModel_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        def move_agent(key, pos):
            ...
            c1 = 0 <= new_pos[1] < maze.size
            c2 = 0 <= new_pos[0] < maze.size
            if c1 and c2:
